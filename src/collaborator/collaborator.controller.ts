...
export class CollaboratorController {
  ...
  @Get('/file/:cpf/:file')
  findFile(@Param('cpf') cpf: string, @Param('file') file: string) {
  ...
  findPercentage(@Param('cpf') cpf: string, @Param('file') file: string) {
    return this.collaboratorService.findPercentage(cpf);
  }
  ...
  updatePassword(
    @Param('CPF') CPF: string,
    @Body() updatePasswordCollaboratorDto: UpdatePasswordCollaboratorDto,
  ) {
    return this.collaboratorService.updatePassword(
      CPF,
  ...
  updateIdWork(
    @Param('CPF') CPF: string,
    @Body() updateCollaboratorDto: UpdateIdWorkCollaboratorDto,
  ) {
  ...
  @Delete('del/files')
  removeFiles(@Body() deleteFilesAnnouncementDto: DeleteFilesCollaboratorDto) {
    return this.collaboratorService.removeFile(deleteFilesAnnouncementDto.key);
  }
}
